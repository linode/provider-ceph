...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v1.0.5-rc.0.1.g5ce0f54
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v1.0.5-rc.0.1.g5ce0f54
EOF
```
