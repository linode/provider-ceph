...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v0.0.48-rc.0.1.g5553134
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v0.0.48-rc.0.1.g5553134
EOF
```
