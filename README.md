...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v1.0.5-rc.0.10.g2e8d85a
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v1.0.5-rc.0.10.g2e8d85a
EOF
```
