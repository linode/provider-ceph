...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v0.0.44-rc.0.11.gedf2688
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v0.0.44-rc.0.11.gedf2688
EOF
```
