...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v1.2.2-rc.0.1.g92f6c1b
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v1.2.2-rc.0.1.g92f6c1b
EOF
```
