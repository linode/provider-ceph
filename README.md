...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v1.3.5-rc.0.10.g8be7d5c
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v1.3.5-rc.0.10.g8be7d5c
EOF
```
