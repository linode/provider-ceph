...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v1.3.0-rc.0.1.g5d99aa4
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v1.3.0-rc.0.1.g5d99aa4
EOF
```
