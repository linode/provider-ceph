...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v0.0.44-rc.0.4.g33fe448
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v0.0.44-rc.0.4.g33fe448
EOF
```
