...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v1.0.6-rc.0.1.g0e66bf8
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v1.0.6-rc.0.1.g0e66bf8
EOF
```
