...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v1.3.2-rc.0.9.ga64166f
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v1.3.2-rc.0.9.ga64166f
EOF
```
