...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v1.3.2-rc.0.1.g7adf958
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v1.3.2-rc.0.1.g7adf958
EOF
```
