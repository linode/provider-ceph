...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v0.0.43-rc.0.5.g86269fe
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v0.0.43-rc.0.5.g86269fe
EOF
```
