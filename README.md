...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v1.0.7-rc.0.12.g12b6de1
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v1.0.7-rc.0.12.g12b6de1
EOF
```
