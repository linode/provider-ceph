...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v0.0.43-rc.0.4.gb5a4db6
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v0.0.43-rc.0.4.gb5a4db6
EOF
```
