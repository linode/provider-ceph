...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v0.0.48-rc.0.8.g784c4ca
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v0.0.48-rc.0.8.g784c4ca
EOF
```
