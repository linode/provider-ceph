...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v1.1.1-rc.0.8.g11cb232
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v1.1.1-rc.0.8.g11cb232
EOF
```
