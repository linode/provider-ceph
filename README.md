...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v1.0.5-rc.0.9.gab29ad7
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v1.0.5-rc.0.9.gab29ad7
EOF
```
