...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v0.0.48-rc.0.3.g65d0fd3
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v0.0.48-rc.0.3.g65d0fd3
EOF
```
