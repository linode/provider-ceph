...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v1.0.3-rc.0.11.g93b272d
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v1.0.3-rc.0.11.g93b272d
EOF
```
