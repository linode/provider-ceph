...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v1.3.2-rc.0.4.gcfc167c
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v1.3.2-rc.0.4.gcfc167c
EOF
```
