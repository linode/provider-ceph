...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v0.0.46-rc.0.25.g3b80b51
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v0.0.46-rc.0.25.g3b80b51
EOF
```
