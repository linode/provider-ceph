...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v1.3.5-rc.0.13.g97a57ec
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v1.3.5-rc.0.13.g97a57ec
EOF
```
