...
```
up ctp provider install xpkg.upbound.io/linode/provider-ceph:v0.0.44-rc.0.3.g7222cb9
```
...
spec:
  package: xpkg.upbound.io/linode/provider-ceph:v0.0.44-rc.0.3.g7222cb9
EOF
```
